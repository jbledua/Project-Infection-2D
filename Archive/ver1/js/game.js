...
class Game{
	constructor(){
		...
		this.canvasElm.width = 250;
		this.canvasElm.height = 250;
		...
		this.sprite1Pos = new Point(0,100);
	...
	update()
	{
		...
		this.sprite1Pos.x = (this.sprite1Pos.x + 0.8) % 256;


		this.sprite2Pos.x = (this.sprite2Pos.x + 0.9) % 256;
